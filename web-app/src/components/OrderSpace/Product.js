...
import { deleteOrderProduct, getOrders } from "../../reducers/action-creators";
...
class Product extends React.Component {
    ...
    handleDeleteProduct = () => {
        this.props.deleteOrder(this.props.productId, this.props.orderId, this.props.userId);
...
function mapDispatchToProps(dispatch) {
    return {
        deleteOrder: (productId, orderId, userId) => dispatch(deleteOrderProduct(productId, orderId, userId)),
